...
public class hos_blood_received_details extends javax.swing.JFrame {

    String f_id = null;

    public hos_blood_received_details(String g_id) {
        initComponents();
        f_id = g_id;
        ...
        try {
            ...
            try ( Connection conn = DriverManager.getConnection(myUrl, "rootze", "root1717")) {
                ...
                ResultSet rs = stmt.executeQuery("select requested_id,ngo_id,ngo_name,o_positive,o_negative,ab_positive,ab_negative,a_positive,a_negative,b_positive,b_negative,msg from hospital_blood_requested where status='Received' and hospital_id='" + f_id + "'");
                Object columnHeaders[] = {"Requested ID", "NGO ID", "NGO Name", "O+ in unit", "O- in unit", "AB+ in unit", "AB- in unit", "A+ in unit", "A- in unit", "B+ in unit", "B- in unit", "Message"};
...
//            JOptionPane.showMessageDialog(this, e);
    ...
    private void initComponents() {
        ...
        setTitle("BLOOD RECEIVED");
        setBackground(new java.awt.Color(255, 255, 255));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Hospital/NormalSearch_1.png"))); // NOI18N

        combo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] {"Requested ID","NGO ID","NGO Name","O+ in unit","O- in unit","AB+ in unit","AB- in unit","A+ in unit","A- in unit","B+ in unit","B- in unit","Message"}));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Request ID", "NGO ID", "NGO Name", "O+ in mL", "O- in mL", "AB+ in mL", "AB- in mL", "A+ in mL", "A- in mL", "B+ in mL", "B- in mL", "Message", "Status"
            }
        ));
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(35, 35, 35)
                        .addComponent(combo, javax.swing.GroupLayout.PREFERRED_SIZE, 313, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(40, 40, 40)
    ...
    private void filter(String fill, String text) {
        try {
            ...
            try ( Connection conn = DriverManager.getConnection(myUrl, "rootze", "root1717")) {
                Statement stmt = conn.createStatement();
                ResultSet rs = stmt.executeQuery("select requested_id,ngo_id,ngo_name,o_positive,o_negative,ab_positive,ab_negative,a_positive,a_negative,b_positive,b_negative,msg from hospital_blood_requested where (status='Received' and hospital_id='" + f_id + "') and " + fill + " like '" + text + "%'");
                Object columnHeaders[] = {"Requested ID", "NGO ID", "NGO Name", "O+ in unit", "O- in unit", "AB+ in unit", "AB- in unit", "A+ in unit", "A- in unit", "B+ in unit", "B- in unit", "Message"};
                com.mysql.cj.jdbc.result.ResultSetMetaData rsmd;
                DefaultTableModel dtm = new DefaultTableModel();
                rsmd = (com.mysql.cj.jdbc.result.ResultSetMetaData) rs.getMetaData();
            ...
            System.out.println("Hospital Blood Received Details");
//            JOptionPane.showMessageDialog(this, e);
        }
    }
    ...
    private void button1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button1ActionPerformed
        ...
        try {
            ...
            if (combo.getSelectedItem() == "NGO ID") {
                filter("ngo_id", search.getText());
            }
            if (combo.getSelectedItem() == "NGO Name") {
                filter("ngo_name", search.getText());
            }
    ...
    private void button3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button3ActionPerformed
        // TODO add your handling code here:
        new hos_blood_received_details(f_id).setVisible(true);
        setVisible(false);
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(hos_blood_received_details.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            String str = null;
            new hos_blood_received_details(str).setVisible(true);
        });
    }
